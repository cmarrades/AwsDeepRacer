# -*- coding: utf-8 -*-
"""
Created on Wed Jun 26 09:11:14 2019
...
def reward_function(params):
    ...
    if not all_wheels_on_track:
        ...
        reward = ((closestWaypontsReward * 0.05) + (distanceFromCenterReward * 0.35) + (progressReward * 0.27) + (allWheelsOnTrackReward * 0.33)) * speedPenalization
